...
//     in-memory in flows/issue-intake.js), separate from the LLM assistant's
//     ConversationStore in thread-context/.
...
export async function getWorkersBySite(siteId) {
  ...
  // listeners/commands/broadcast-safety.js) runnable before the DB is wired up.
  return [];
}
