...
//     SMS intake flows (e.g. the ISSUE keyword flow), separate from the
//     Slack-side SessionStore in thread-context/.
...
export async function getWorkersBySite(siteId) {
  ...
  // trigger_safety_broadcast) runnable before the DB is wired up.
  return [];
}
